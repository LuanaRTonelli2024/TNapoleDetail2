// src/components/appointmentshistory.js
...
const AppointmentsHistory = () => {
    ...
    const handleCancelAppointment = (appointmentId) => {
        ...
        if (user) {
            ...
            remove(ref(database, `appointments/${user.uid}/${appointmentId}`))
                .then(() => {
                            ...
                            <div className="appointment-details">
                                {isEditing ? (
                                    ...
                                    <div>
                                        ...
                                        <p><strong>Vehicle:</strong> {appointmentDetails.vehicle}</p> <p><strong>Status:</strong> {appointmentDetails.status || 'Pending'}</p>
